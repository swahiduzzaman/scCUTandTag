...
# scC&TPEAK: a benchmark suite for scCUT&Tag peak-calling across diverse epigenomic contexts

**scC&TPEAK** is a fully reproducible benchmarking framework designed to systematically evaluate seven widely used peak-calling algorithms on single-cell CUT&Tag (scCUT&Tag) datasets.
